...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/scripts/ComfyUI/Install-ComfyUI.ps1' -OutFile '%ScriptsFolder%\Install-ComfyUI.ps1'"
echo   - Telechargement de Update-ComfyUI.ps1...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/scripts/ComfyUI/Update-ComfyUI.ps1' -OutFile '%ScriptsFolder%\Update-ComfyUI.ps1'"
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command "[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; Invoke-WebRequest -Uri 'https://huggingface.co/UmeAiRT/ComfyUI-Auto_installer/resolve/main/scripts/ComfyUI/UmeAiRT-Update-ComfyUI.bat' -OutFile '%~dp0UmeAiRT-Update-ComfyUI.bat'"
